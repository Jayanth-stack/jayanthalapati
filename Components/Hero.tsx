...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
        ...
        <div className="h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.02] bg-grid-black/[0.01]  flex items-center justify-center absolute top-0 left-0">
        ...
        <div className='flex justify-center relative my-20 z-10'>
          <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
            <h2 className='uppercase tracking-widest text-xs text-center dark:text-blue-100 text-black max-w-80'>
                Dymanic Web Magic with Next.js
            </h2>
